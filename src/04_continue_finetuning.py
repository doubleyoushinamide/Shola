...
def main():
    ...
    num_epochs = 10  # Set as needed for continued training
    grad_accum_steps = 2
    model_ckpt = '/kaggle/input/lora-finetuned/lora_finetuned.pth'  # Path to previous checkpoint
    ...
    # Save model
    torch.save({'model_state_dict': unet.state_dict()}, '/kaggle/working/lora_finetuned_continued.pth')
    print("Model saved to /kaggle/working/lora_finetuned_continued.pth")
